...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uxwi31i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uxwi31i.containers.anotherwebservice.com/
...
```
git clone git@github.com:thienphong0/container-uxwi31i.git
cd container-uxwi31i
```
...
```
docker attach container-uxwi31i
```
